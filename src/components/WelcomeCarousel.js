      ...
      <div style={{ padding: '30px' }}>
        <Row type="flex" justify="space-around" align="top">
          ...
          >
            ...
            />
            <p className="describe">
              Thank you to everyone who came to Baramee Thai Bistro on Sunday,
              March 18, 2019 for the special blessing of the restaurant. We
              enjoyed everyone’s company and it is always wonderful to see the
              Thai community come together to enjoy food and each other’s
              company. It makes us happy to see everyone in their traditional
              Thai costumes and sharing our culture with everyone. Thank you to
              our special guest หลวงพี่ Kamron Yaemyuen for making the journey
              from California to perform the blessing.
            </p>
          </Col>
        </Row>
      </div>

export const FromTheWorkData = [
  ...
  {
    name: 'Thai Cashew Nuts',
    description:
      'Meat or Tofu stir-fried with chili oil and roasted cashew nuts, onion, broccoli, fresh carrot and bell peppers.',
    image: {
      path: 'https://i.imgur.com/hwXPb1Il.jpg',
      isPortrait: false,
    },
    price: {
      lunch: [
  ...
  {
    name: 'Crispy Garlic Shrimp',
    description:
      'Jumbo shrimp flash fried and then sautéed in our delicious garlic sauce. Served over a bed of steamed vegetables.',
    image: {
      path: 'https://i.imgur.com/Qsq3xhal.jpg',
      isPortrait: true,
    },
    price: {
      lunch: [],
